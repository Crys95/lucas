...
export const ProjectCard = ({ ability, src, subTitle, title }: cardProps) => {
  return (
    <div className="max-w-[350px] rounded-lg h-[436px] flex flex-col bg-gray-800 overflow-hidden border-2 border-gray-800 hover:border-amber-500 opacity-60 hover:opacity-100 transition-all">
